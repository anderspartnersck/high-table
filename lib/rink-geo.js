...
var RINK_PRESETS = {
  ...
  penalty_box_top: { id:'penalty_box_top', view:'top', mode:'trapezoid',  image:'sprites/table_nachos_top.png',  corners:{tl:[0.3601,0.1552],tr:[0.6383,0.1589],br:[0.7446,0.8302],bl:[0.253,0.8363]}, goalHalf:0.141, goalAxis:'v', centerV:0.42, goals:GOALMOUTH, notes:'LOCKED 2026-06-18 (Joe). Steep perspective. centerV 0.42 (RINK LAB 2026-06-19).' },
};
var SIDE_PRESETS = {
  ...
  nachos_side_1:  { id:'nachos_side_1',  view:'side', mode:'homography', image:'sprites/table_nachos_side.png',  corners:{tl:[0.3652,0.3131],tr:[0.6365,0.3143],br:[0.8506,0.7965],bl:[0.1402,0.7927]}, goalHalf:0.13, goalAxis:'v', centerV:0.52, goals:GOALMOUTH, notes:'re-traced on REDO art + centerV 0.58 (RINK LAB 2026-06-19).' },
  nachos_side_2:  { id:'nachos_side_2',  view:'side', mode:'homography', image:'sprites/table_nachos_side2.png', corners:{tl:[0.3518,0.3219],tr:[0.6314,0.3244],br:[0.8363,0.8002],bl:[0.1528,0.7939]}, goalHalf:0.127, goalAxis:'v', centerV:0.585, goals:GOALMOUTH, notes:'re-traced on REDO art; centerV 0.525->0.585 (RINK LAB 2026-07-08).' },
  killscreen_side_1: { id:'killscreen_side_1', view:'side', mode:'homography', image:'sprites/table_killscreen_side.png',  corners:{tl:[0.3387,0.2712],tr:[0.675,0.2731],br:[0.9263,0.785],bl:[0.1175,0.7831]}, goalHalf:0.137, goalAxis:'v', centerV:0.605, goals:GOALMOUTH, notes:'RE-TRACED 2026-07-08 (Joe, RINK LAB) on the new size-1 art — CASTLE KILLSCREEN, HYSCORE FOREST purple end.' },
  killscreen_side_2: { id:'killscreen_side_2', view:'side', mode:'homography', image:'sprites/table_killscreen_side2.png', corners:{tl:[0.3613,0.2746],tr:[0.6613,0.2764],br:[0.885,0.7574],bl:[0.1338,0.763]}, goalHalf:0.111, goalAxis:'v', centerV:0.53, goals:GOALMOUTH, notes:'RE-TRACED 2026-07-08 (Joe, RINK LAB) on the new size-2 art — CASTLE KILLSCREEN green/arcade end.' },
...
var MOUSE_PRESETS = {
  nachos_mouse:   { id:'nachos_mouse',   view:'top', mode:'homography', image:'sprites/table_nachos_top_land.png', corners:{tl:[0.1013,0.1182],tr:[0.9,0.1],br:[0.9,0.9],bl:[0.0837,0.8479]}, goalHalf:0.13, goalAxis:'u', centerV:0.565, goals:GOALMOUTH, notes:'Mouse venue — Penalty Box Nachos (landscape top). re-traced + centerV 0.565 (RINK LAB 2026-06-19).' },
